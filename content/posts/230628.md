---
title: 论文阅读：Backpack Language Models
date: '2023-06-28 11:15:17'
tags:
- LLM
plugins:
- mathjax
...
> 🔗：https://arxiv.org/pdf/2305.16765.pdf
> 代码：https://backpackmodels.science
> 作者团队：Department of Computer Science, Stanford University
> ACL 2023 长文
...
$$
C(x)_1, C(x)_2, \dots, C(x)_k
$$
记词输出为$\textbf{o}_i$，有：
$
\textbf{o}_i = \sum_{j=1}^{n}\sum_{\ell=1}^{k}\alpha_{\ell ij}C(x_j)_{\ell}
$
## 实验
